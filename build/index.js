...
var Checkbox = function (_a) {
    ...
    return (React.createElement("div", { style: { display: "flex", flexDirection: "row", alignItems: "center" } },
        React.createElement(StyledCheckbox, { type: "checkbox", id: id, checked: value, disabled: disabled, onChange: function (e) {
                onChange(e.target.checked);
            } }),
        React.createElement("label", { htmlFor: id, style: { color: disabled ? colors.darkGrey : colors.black } }, label)));
};
...
var IconWithMessage = function (_a) {
    ...
    return (React.createElement("div", { style: {
        ...
        icon,
        showMessage && React.createElement(Message, { message: message })));
};
...
var PasswordInput = function (_a) {
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement("div", { style: { position: "relative" } },
            React.createElement(StyledTextInput, { id: id, disabled: disabled, title: disabled ? disabledReason : undefined, style: { paddingRight: "35px" }, autoComplete: autocomplete, error: error !== undefined, type: showPassword ? "text" : "password", value: value, onChange: onChangeHandler, onFocus: function () {
                    setIsFocused(true);
                }, onBlur: function () {
                    setIsFocused(false);
                } }),
            React.createElement(Touchable, { style: {
                    position: "absolute",
                    bottom: 1,
                    right: 4,
                    display: "flex",
                ...
                } }, showPassword ? React.createElement(io.IoIosEyeOff, { size: 25 }) : React.createElement(io.IoIosEye, { size: 25 }))),
        React.createElement(Label, { disabled: disabled, color: isFocused
                ? colors.active
                : error !== undefined
                    ? colors.error
                    : undefined, htmlFor: id },
            label,
            error && (React.createElement(IconWithMessage, { icon: React.createElement(io.IoIosWarning, { id: "warning-icon-input", size: 20, color: colors.error, style: { marginLeft: "8px" } }), message: error })))));
};
...
var Submit = function (_a) {
    ...
    return React.createElement(SubmitButton, { type: "submit", value: placeholder, disabled: disabled });
};
...
var TextInput = function (_a) {
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement(StyledTextInput, { id: id, disabled: disabled, title: disabled ? disabledReason : undefined, error: error !== undefined, type: "text", value: value, onChange: onChangeHandler, onFocus: function () {
                setIsFocused(true);
            }, onBlur: function () {
                setIsFocused(false);
            } }),
        React.createElement(Label, { disabled: disabled, color: isFocused
                ...
                : error !== undefined
                    ...
                    : undefined, htmlFor: id },
            label,
            optional && React.createElement(OptionalLabel, null, "Optional"),
            error && (React.createElement(IconWithMessage, { icon: React.createElement(io.IoIosWarning, { size: 20, color: colors.error, style: { marginLeft: "8px" } }), message: error })))));
};
